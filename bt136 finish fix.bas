...
')
      ...
      ')
         ...
         IF TIMER1<LIGHT(5) THEN RESET OUT5 ELSE SET OUT5
         IF TIMER1<LIGHT(6) THEN RESET OUT6 ELSE SET OUT6
         IF TIMER1<LIGHT(7) THEN RESET OUT7 ELSE SET OUT7
         IF TIMER1<LIGHT(8) THEN RESET OUT8 ELSE SET OUT8
         '(
         SELECT CASE LIGHT(2)
            CASE DARK
               RESET OUT2
