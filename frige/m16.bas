...
motor alias portc.1:config portc.1=OUTPUT
fan alias portc.2:config portc.2=OUTPUT
out1 alias portc.3:config portc.3=OUTPUT
out2 alias portc.4 :config portc.4=OUTPUT
