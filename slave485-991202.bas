...
Rel1 Alias Portd.2 : Config Pind.2 = Output
Rel2 Alias Portd.3 : Config Pind.3 = Output
Rel3 Alias Portd.4 : Config Pind.4 = Output
Rel4 Alias Portd.5 : Config Pind.5 = Output
Led1 Alias Portc.4 : Config Pinc.4 = Output
Key1 Alias Pinc.0 : Config Pinc.0 = Input
'Config Scl = Portb.2
'Config Sda = Portb.1
