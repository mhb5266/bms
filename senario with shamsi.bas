...
Sub Set_id_modules
                 ...
                 Lcdat 5 , 1 , Farsi( "åãÇåä ˜ÑÏä")
                 Lcdat 7 , 1 , Farsi( "æÑæÏí æ ÎÑæÌí")
    Do
      Call Readtouch
      If Touch = 4 Then
         Cls
      ...
      If Touch = 1 Then
                 Cls
                 Lcdat 5 , 1 , Farsi( "ÎÑæÌí ÈÚÏí")
                 Lcdat 7 , 1 , Farsi( "ÑÇ ÇäÊÎÇÈ ˜äíÏ")
...
Sub Remote_menu
    ...
    Do
        ...
        End If
        Lcdat 1 , 1 , Farsi( "ÊäÙíãÇÊ ÑíãæÊ   ") , 1
        ...
        Select Case Count
               Case 1
                    Lcdat 3 , 1 , Farsi( "ÍÐÝ æÑæÏí åÇ    ")
               Case 2
                    Lcdat 3 , 1 , Farsi( "ÐÎíÑå ÑíãæÊ     " )
               'Case 3
                    'Lcdat 3 , 1 , "Config Remotes  "
        End Select
    Loop
