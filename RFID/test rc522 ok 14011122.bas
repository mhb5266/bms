...
Sub Rc522_read(byval Block As Byte)
   ...
   If Backleng = 144 Then                                   '144Bit 18Byte
      ...
      For Temp2 = 1 To 16
         ...
         Print "temp";temp2;"= "; Chr(rc522_inbuffer(temp2))
         waitms 500
      Next
   End If
   '(
   If Backleng = 40 Then                                   '144Bit 18Byte
      Print "Read 16Byte-- "                               'Dump 16Byte Buffer
      waitms 500
      For Temp2 = 1 To 60
         Print "temp";temp2;"= "; Chr(rc522_inbuffer(temp2))
         waitms 500
         'if Chr(rc522_inbuffer(temp2))="2" then
            'set good
            'waitms 500
            'reset good
         'end if
