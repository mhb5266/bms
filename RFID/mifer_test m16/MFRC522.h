...
#define cs_set PORTB.2=1
#define cs_clr PORTB.2=0
...
unsigned char read_keys(unsigned char keyA[6],unsigned char keyB[6],unsigned char sector_num,unsigned char key[6]){
...
unsigned char change_keys(unsigned char keyA[6],unsigned char keyB[6],unsigned char sector_num,unsigned char key[6]){
   unsigned char dd[20],stat,k;
   ...
   if(!stat){
      ...
      dd[6]=0xFF;dd[7]=0x07;dd[8]=0x80;dd[9]=0x69;
