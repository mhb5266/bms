...
Do
   If Ischarwaiting() = 0 Then                            'when there is no data
   ...
   ' either call it manual in your main loop or you buffered input with BYTEMATCH=ALL option
     ...
     if b=10 then
      ...
      print,"OK"
      reset rs485dir
     endif                                         'call this once in a while
   End If
Loop
            ...
            Select Case Mbfunc
              Case 3 :                                      'read function 3
                       ...
                       For Mbj = 1 To Mbruncount
                         print  Chr(mbruncheck(mbj));   'send out this data
                       Next
                       Reset Rs485dir
