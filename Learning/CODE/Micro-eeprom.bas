...
_in Alias Pinb.0 : Config Pinb.0 = Input                    'RF input
Buzz Alias Portc.5 : Config Pinc.5 = Output
Led1 Alias Portc.4 : Config Pinc.4 = Output                 'learning led
Key1 Alias Pinc.0 : Config Pinc.0 = Input                   'learn key
                                          'B.1
Rel1 Alias Portd.2 : Config Pind.2 = Output                 'relay1
Rel2 Alias Portd.3 : Config Pind.3 = Output                 'relay2
Rel3 Alias Portd.4 : Config Pind.4 = Output                 'relay3
Rel4 Alias Portd.5 : Config Pind.5 = Output                 'relay4
Config Portc.3 = Output : Pg Alias Portc.3
